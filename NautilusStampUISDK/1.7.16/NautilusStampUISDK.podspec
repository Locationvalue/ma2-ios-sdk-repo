Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusAnalyticsSDK", "1.7.16"
  spec.dependency "NautilusConfigSDK", "1.7.16"
  spec.dependency "NautilusContainerSDK", "1.7.16"
  spec.dependency "NautilusCoreSDK", "1.7.16"
  spec.dependency "NautilusStampSDK", "1.7.16"
  spec.dependency "NautilusCodeReaderSDK", "1.7.16"
  spec.dependency "NautilusUISDK", "1.7.16"
  spec.dependency "NautilusServerTimeSDK", "1.7.16"
  spec.dependency "NautilusImagingSDK", "1.7.16"
