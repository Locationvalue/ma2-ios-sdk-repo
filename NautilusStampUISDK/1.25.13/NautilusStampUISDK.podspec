Pod::Spec.new do |spec|
  ...
  if ENV.has_key?('NAUTILUS_DEVELOP') then
    ...
    spec.resources = "Nautilus-ios-sdk/StampUI/Resources/moduleapps-stampcard-ui.json", "Nautilus-ios-sdk/StampUI/Resources/Assets.xcassets", "Nautilus-ios-sdk/StampUI/Sources/**/*.xib", "Nautilus-ios-sdk/StampUI/Sources/**/*.storyboard", "Nautilus-ios-sdk/StampUI/Resources/ma_stampcard_detail_lap_complete_dialog_animation.json"
  else
    # Setting for release
