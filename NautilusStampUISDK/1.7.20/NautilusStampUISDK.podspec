Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusStampSDK", "1.7.20"
  spec.dependency "NautilusCodeReaderSDK", "1.7.20"
  spec.dependency "NautilusUISDK", "1.7.20"
  spec.dependency "NautilusServerTimeSDK", "1.7.20"
