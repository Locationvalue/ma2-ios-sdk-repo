Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.7.19"
  spec.dependency "NautilusContainerSDK", "1.7.19"
  spec.dependency "NautilusConfigSDK", "1.7.19"
  spec.dependency "NautilusIdentifySDK", "1.7.19"
  spec.dependency "NautilusLoggingSDK", "1.7.19"
  spec.dependency "NautilusImagingSDK", "1.7.19"
  spec.dependency "NautilusAnalyticsSDK", "1.7.19"
  spec.dependency "NautilusUISDK", "1.7.19"
  spec.dependency "NautilusLotterySDK", "1.7.19"
  spec.dependency "NautilusServerTimeSDK", "1.7.19"
