Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.7.14"
  spec.dependency "NautilusContainerSDK", "1.7.14"
  spec.dependency "NautilusConfigSDK", "1.7.14"
  spec.dependency "NautilusIdentifySDK", "1.7.14"
  spec.dependency "NautilusLoggingSDK", "1.7.14"
  spec.dependency "NautilusImagingSDK", "1.7.14"
  spec.dependency "NautilusAnalyticsSDK", "1.7.14"
  spec.dependency "NautilusUISDK", "1.7.14"
  spec.dependency "NautilusLotterySDK", "1.7.14"
  spec.dependency "NautilusServerTimeSDK", "1.7.14"
