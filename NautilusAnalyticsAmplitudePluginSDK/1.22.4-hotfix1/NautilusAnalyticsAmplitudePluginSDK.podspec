Pod::Spec.new do |spec|
  ...
  spec.dependency "AmplitudeSwift", "1.14.0"
  spec.dependency "AmplitudeSessionReplay", "0.5.2"
  spec.dependency "AmplitudeSwiftSessionReplayPlugin", "0.5.2"
